...
namespace silnith::game::solitaire::move::filter
{
    ...
    bool StockPileRecycleMustBeFollowedByAdvanceFilter::should_filter(std::shared_ptr<linked_node<game_state<solitaire_move, board>>> const& game_state_history) const
    {
